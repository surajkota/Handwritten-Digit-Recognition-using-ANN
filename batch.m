...
for i=1:epochs
    ...
    if mod(i,100)==0
        ...
        classification_accuracyTr(count)=(correctlyClassifiedTr/trainingSetSize)*100;
        errorTr(count) = error/trainingSetSize;
